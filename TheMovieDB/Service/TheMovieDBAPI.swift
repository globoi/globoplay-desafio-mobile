...
private var data = TheMovieDBAPI()

class TheMovieDBAPI: NSObject {
    
    private var apiKey = "c5850ed73901b8d268d0898a8a9d8bff"
        private var language = "pt-BR"
        
        public var mapGenres = [Int64: Genre]()
        
        public class var sharedInstance: TheMovieDBAPI {
            return data
        }
        ...
        func addFavorite(card: Card) {
            ...
            if !TheMovieDBAPI.sharedInstance.checkAlreadyAdded(card: card) {
