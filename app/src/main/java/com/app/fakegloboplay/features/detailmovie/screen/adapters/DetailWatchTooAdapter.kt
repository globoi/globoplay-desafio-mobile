...
import com.app.fakegloboplay.databinding.VhHomeItemBinding
...
class DetailWatchTooAdapter :
    RecyclerView.Adapter<DetailWatchTooAdapter.DetailWatchTooAdapterVH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DetailWatchTooAdapterVH =
        DetailWatchTooAdapterVH(
    ...
    override fun onBindViewHolder(holder: DetailWatchTooAdapterVH, position: Int) {
        holder.bind(getItem(position))
    }

    inner class DetailWatchTooAdapterVH(private val binding: VhMovieItemBinding) :
